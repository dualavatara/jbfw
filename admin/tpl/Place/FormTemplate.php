...
class FormTemplate extends Template {
	...
	protected function show($data, $content = null) {
		$place = isset($data['object']) ? $data['object'] : null;
	...
	<div class="group">
		<div class="capture"><?php echo $place ? 'Редактирование' : 'Создание';?></div>
		<div id="tabs">
			<a href="#general">Общие</a>
		</div>
		<form method="post" id="editForm" class="required" minlength="2" action="<?php echo $this->getUrl('place_save'); ?>" enctype="multipart/form-data">
			<input type="hidden" name="form[id]" value="<?php echo $place->id ? : ''; ?>"/>
				...
				<table>
						...
						<?php
							...
							foreach($dRaw['model']->fields as $field) {
								...
								echo '<td>' .$field->input($place). '</td></tr>';
							}
						?>
